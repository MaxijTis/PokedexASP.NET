...
namespace Negocio
{
    public class PokemonNegocio
    {
        ...
        public List<Pokemon> filtrar(string campo, string criterio, string filtro, string estado)
        {
            ...
            try
            {
                string consulta = "Select Numero, Nombre, P.Descripcion, UrlImagen, E.Descripcion Tipo, D.Descripcion Debilidad, P.IdTipo, P.IdDebilidad, P.Activo, P.Id From POKEMONS P, ELEMENTOS E, ELEMENTOS D Where E.Id = P.IdTipo And D.Id = P.IdDebilidad And  ";
                if (campo == "Número")
                {
                    switch (criterio)
                    {
